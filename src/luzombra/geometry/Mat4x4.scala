...
object Mat4x4 {
  ...
  def det(mat: Array[Double]): Double = {

    def d(mat: Array[Double]): Double = {
  ...
  /** Returns an array containing a square matrix made up by the cofactors of the
    ...
    */
  private def c(mat: Array[Double], row: Int, col: Int, n: Int): Array[Double] = {
  ...
  def inv(mat: Array[Double]): Array[Double] = {
    val n = math.sqrt(mat.length).toInt
  ...
  private def fromArray(mat: Array[Double]): Mat4x4 = {
